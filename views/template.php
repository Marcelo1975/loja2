				...
				<div class="row">
					...
					<div class="col-sm-3">
						<a href="<?php echo BASE_URL; ?>cart">
							<div class="cartarea">
								<div class="carticon">
									<div class="cartqt"><?php echo (isset($_SESSION['cart']))?$viewData['cart_qt']:'0'; ?></div>
								</div>
								<div class="carttotal">
...
<form action="//naofiquefora.us16.list-manage.com/subscribe/post?u=c1ad6a767fabd350ef1d19f18&amp;id=8227081280" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	<input type="email" value="" name="EMAIL" class="subemail required email" id="mce-EMAIL" placeholder="<?php $this->lang->get('SUBSCRIBETEXT'); ?>" />
	<input type="hidden" name="b_c1ad6a767fabd350ef1d19f18_8227081280" tabindex="-1" value="">
